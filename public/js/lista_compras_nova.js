...
async function nova() {
    ...
    if (!id_estoque) {
        document.getElementById('error-estoque').textContent = 'Selecione o estoque que recebera os produtos comprados';
        return;
    }
...
async function carregarEstoques() {
    ...
    if (resposta.status == 'ok') {
        ...
        document.getElementById('error-estoque').textContent = 'Cadastre um estoque antes de criar a lista';
    }
}
