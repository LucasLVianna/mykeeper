...
<section class="page-view">
    <div class="page-heading">
        <div>
            ...
            <p class="page-subtitle">Atualize os dados do item selecionado.</p>
        </div>
    </div>
            ...
            <div class="surface-content">
                <form class="stack-form">
                    <div class="field-group">
                        ...
                        <input class="field-control" type="text" name="nome_produto" id="nome_produto">
                    ...
                    <div class="inline-actions">
                        ...
                        <button type="button" id="alterarproduto" class="button button-primary">Salvar alterações</button>
                    </div>
                </form>
            </div>
        </section>
...
<script src="/mykeeper-lucas_vianna/public/js/produto_alterar.js"></script>
